...
export default function AlumniForm() {
  ...
  const validateForm = () => {
    ...
    if (!formData.studentId.trim()) {
      newErrors.studentname = 'StudentId is required';
      isValid = false;
    }
    if (!formData.class.trim()) {
      newErrors.studentname = 'Student class is required';
      isValid = false;
    }
  ...
  return (
   <div className="bg-white dark:bg-gray-900 min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    <h1 className='dark:text-white text-3xl flex justify-center ml-auto'>Add Result</h1>
  <form
  ...
  >
    ...
    <div>
      <label className="block mb-1 text-gray-800 dark:text-gray-100">Student  Id *</label>
      <input
        type="text"
      ...
      {errors.studentId && (
       ...
       <div>
  <label htmlFor="class" className="block mb-1 text-gray-800 dark:text-gray-100">
    class *
  </label>
  <select
    id="class"
  ...
  {errors.class && (
    ...
    <div>
      <label className="block mb-1 text-gray-800 dark:text-gray-100">Position *</label>
      <input
        type="text"
